...
perform_s2 <- function(i, ndev, n.para, beta0, beta, nval, prev, auc, n.restrict = NULL){
                                                                                                     ...
                                                                                                     eta_true <- rep(beta0, nval) + as.matrix(xval)%*%beta
                                                                                                     ...
                                                                                                     method_result[4,] <- c(prev, auc, ndev, 3, measures(yval, uni_p_05, p_true), varsel_uni_05, p_threshold)
                                                                                                     ...
                                                                                                     method_result[6,] <- c(prev, auc, ndev, 5, safe_measures(yval, uni05_back_p, p_true, method = 5, i = i), varsel_uni05_back, 0.05)
                                                                                                     ...
                                                                                                     method_result[7,] <- c(prev, auc, ndev, 6, safe_measures(yval, uni15_back_p, p_true, method = 6, i = i), varsel_uni15_back, 0.15)
                                                                                                     ...
                                                                                                     method_result[8,] <- c(prev, auc, ndev, 7, safe_measures(yval, lassomin_p, p_true, method = 7, i = i), varsel_min, lambda_min)
                                                                                                     method_result[9,] <- c(prev, auc, ndev, 8, safe_measures(yval, lasso1se_p, p_true, method = 8, i = i), varsel_1se, lambda_1se)
                                                                                                     ...
                                                                                                     method_result[12, ] <- c(prev, auc, ndev, 11, safe_measures(yval, lasso_min_back_p, p_true, method = 11, i = i), varsel_min_back, lambda_min)
