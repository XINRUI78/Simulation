# select variables using univariable logistic and p-value
# output: variable selection indicator varsel_uni and selected model uni

unilogit <- function(x, y, p_threshold) {
